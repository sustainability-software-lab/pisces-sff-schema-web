...
def build_reproducibility(model_dir, module, env_key=None):
    ...
    -------
    dict
        Conforming to ``metadata.reproducibility`` in SFF v0.0.9.
    """
    model_dir = Path(model_dir).resolve()
...
def run_model_export(model_dir, output_path, sff_version='0.0.9', env_key=None):
    """
...
def main(argv=None):
    ...
    parser.add_argument('--sff-version', default='0.0.9',
